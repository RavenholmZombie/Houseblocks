...
public class BlockRedCorner extends Block {
	
	protected BlockRedCorner(Material material) {
		super(material);
	...
	public void registerBlockIcons(IIconRegister reg) {
	    for (int i = 0; i < 6; i++) {
	        icons[1] = reg.registerIcon("houseblocks:cornerPanel_red");
	    }
	    icons[2] = reg.registerIcon("houseblocks:cornerPanel_red_right");
	}
