...
public class BlockLGreyCorner extends Block {

	protected BlockLGreyCorner(Material material) {
		super(material);
	...
	public void registerBlockIcons(IIconRegister reg) {
	    for (int i = 0; i < 6; i++) {
	        icons[1] = reg.registerIcon("houseblocks:cornerPanel_lightGrey");
	    }
	    icons[2] = reg.registerIcon("houseblocks:cornerPanel_lightGrey_right");
	}
