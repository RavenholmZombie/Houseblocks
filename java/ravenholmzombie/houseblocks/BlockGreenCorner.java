...
public class BlockGreenCorner extends Block {

	protected BlockGreenCorner(Material material) {
		super(material);
	...
	public void registerBlockIcons(IIconRegister reg) {
	    for (int i = 0; i < 6; i++) {
	        icons[1] = reg.registerIcon("houseblocks:cornerPanel_green");
	    }
	    icons[2] = reg.registerIcon("houseblocks:cornerPanel_green_right");
	}
