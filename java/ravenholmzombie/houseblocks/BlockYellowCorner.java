...
public class BlockYellowCorner extends Block {

	protected BlockYellowCorner(Material material) {
		super(material);
	...
	public void registerBlockIcons(IIconRegister reg) {
	    for (int i = 0; i < 6; i++) {
	        icons[1] = reg.registerIcon("houseblocks:cornerPanel_yellow");
	    }
	    icons[2] = reg.registerIcon("houseblocks:cornerPanel_yellow_right");
	}
