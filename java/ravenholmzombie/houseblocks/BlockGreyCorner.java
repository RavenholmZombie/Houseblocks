...
public class BlockGreyCorner extends Block {

	protected BlockGreyCorner(Material material) {
		super(material);
	...
	public void registerBlockIcons(IIconRegister reg) {
	    for (int i = 0; i < 6; i++) {
	        icons[1] = reg.registerIcon("houseblocks:cornerPanel_grey");
	    }
	    icons[2] = reg.registerIcon("houseblocks:cornerPanel_grey_right");
	}
