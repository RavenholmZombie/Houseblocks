...
public class BlockPinkCorner extends Block {

	protected BlockPinkCorner(Material material) {
		super(material);
	...
	public void registerBlockIcons(IIconRegister reg) {
	    for (int i = 0; i < 6; i++) {
	        icons[1] = reg.registerIcon("houseblocks:cornerPanel_pink");
	    }
	    icons[2] = reg.registerIcon("houseblocks:cornerPanel_pink_right");
	}
