...
public class BlockOrangeCorner extends Block {

	protected BlockOrangeCorner(Material material) {
		super(material);
	...
	public void registerBlockIcons(IIconRegister reg) {
	    for (int i = 0; i < 6; i++) {
	        icons[1] = reg.registerIcon("houseblocks:cornerPanel_orange");
	    }
	    icons[2] = reg.registerIcon("houseblocks:cornerPanel_orange_right");
	}
