...
public class BlockPurpleCorner extends Block {

	protected BlockPurpleCorner(Material material) {
		super(material);
	...
	public void registerBlockIcons(IIconRegister reg) {
	    for (int i = 0; i < 6; i++) {
	        icons[1] = reg.registerIcon("houseblocks:cornerPanel_purple");
	    }
	    icons[2] = reg.registerIcon("houseblocks:cornerPanel_purple_right");
	}
