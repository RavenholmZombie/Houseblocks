...
public class BlockCyanCorner extends Block {

	protected BlockCyanCorner(Material material) {
		super(material);
	...
	public void registerBlockIcons(IIconRegister reg) {
	    for (int i = 0; i < 6; i++) {
	        icons[1] = reg.registerIcon("houseblocks:cornerPanel_cyan");
	    }
	    icons[2] = reg.registerIcon("houseblocks:cornerPanel_cyan_right");
	}
