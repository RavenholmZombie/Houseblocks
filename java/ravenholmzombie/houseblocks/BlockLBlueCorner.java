...
public class BlockLBlueCorner extends Block {

	protected BlockLBlueCorner(Material material) {
		super(material);
	...
	public void registerBlockIcons(IIconRegister reg) {
	    for (int i = 0; i < 6; i++) {
	        icons[1] = reg.registerIcon("houseblocks:cornerPanel_lightBlue");
	    }
	    icons[2] = reg.registerIcon("houseblocks:cornerPanel_lightBlue_right");
	}
