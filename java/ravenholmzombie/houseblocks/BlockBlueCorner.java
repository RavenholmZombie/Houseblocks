...
public class BlockBlueCorner extends Block {

	protected BlockBlueCorner(Material material) {
		super(material);
	...
	public void registerBlockIcons(IIconRegister reg) {
	    for (int i = 0; i < 6; i++) {
	        icons[1] = reg.registerIcon("houseblocks:cornerPanel_blue");
	    }
	    icons[2] = reg.registerIcon("houseblocks:cornerPanel_blue_right");
	}
