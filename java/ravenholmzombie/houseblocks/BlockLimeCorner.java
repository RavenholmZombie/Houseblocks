...
public class BlockLimeCorner extends Block {

	protected BlockLimeCorner(Material material) {
		super(material);
	...
	public void registerBlockIcons(IIconRegister reg) {
	    for (int i = 0; i < 6; i++) {
	        icons[1] = reg.registerIcon("houseblocks:cornerPanel_lime");
	    }
	    icons[2] = reg.registerIcon("houseblocks:cornerPanel_lime_right");
	}
