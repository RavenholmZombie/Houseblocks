...
public class BlockBrownCorner extends Block {

	protected BlockBrownCorner(Material material) {
		super(material);
	...
	public void registerBlockIcons(IIconRegister reg) {
	    for (int i = 0; i < 6; i++) {
	        icons[1] = reg.registerIcon("houseblocks:cornerPanel_brown");
	    }
	    icons[2] = reg.registerIcon("houseblocks:cornerPanel_brown_right");
	}
