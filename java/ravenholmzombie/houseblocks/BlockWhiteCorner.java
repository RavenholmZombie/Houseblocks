...
public class BlockWhiteCorner extends Block {

	protected BlockWhiteCorner(Material Material) {
		super(Material);
	...
	public void registerBlockIcons(IIconRegister reg) {
	    for (int i = 0; i < 6; i++) {
	        icons[1] = reg.registerIcon("houseblocks:cornerPanel_white");
	    }
	    icons[2] = reg.registerIcon("houseblocks:cornerPanel_white_right");
	}
