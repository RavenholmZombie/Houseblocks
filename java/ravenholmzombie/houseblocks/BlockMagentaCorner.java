...
public class BlockMagentaCorner extends Block {

	protected BlockMagentaCorner(Material material) {
		super(material);
	...
	public void registerBlockIcons(IIconRegister reg) {
	    for (int i = 0; i < 6; i++) {
	        icons[1] = reg.registerIcon("houseblocks:cornerPanel_magenta");
	    }
	    icons[2] = reg.registerIcon("houseblocks:cornerPanel_magenta_right");
	}
